...
| Representative service PR CI | `services/identity-service/.github/workflows/pr.yml` | Delegates service PR checks to the shared organization workflow with Node, package-manager, integration skip, and coverage threshold inputs. |
